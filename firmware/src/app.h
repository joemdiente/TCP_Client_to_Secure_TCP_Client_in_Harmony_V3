...
typedef enum
{
	...
	APP_STATE_INIT=0,
        ...
        APP_TCPIP_CLOSE_CONNECTION,
            //My Custom App State
        APP_TCPIP_PARSE_IP_PORT,
        APP_TCPIP_OPEN_SECURE_SOCKET,
        APP_TCPIP_WAIT_FOR_SECURE_CONNECTION,
        APP_TCPIP_WAIT_FOR_NEGOTIATION,
        APP_TCPIP_WAIT_FOR_MESSAGE,
        APP_TCPIP_SEND_MESSAGE,
        APP_TCPIP_RECV_MESSAGE,
        APP_TCPIP_ERROR
} APP_STATES;
...
typedef struct
{
    ...
    void* ssl;
    char urlBuffer[256];
    char ipPortBuffer[24]; //Only Supports IPV4 (Joem)
    char message[128]; //Make sure that Command Buffer and UART Buffer can support this
    NET_PRES_SIGNAL_HANDLE receivehandle;
    char * host;
    char * path;
    uint8_t ipMode;
    uint8_t queryState;
...
/* Application Error Codes
  ...
  Summary:
    Application Error Code Enumaration

  Description:
    This enumeration defines the error codes this customer application will return.
*/
